...
const PizzaCard = () => {
    ...
    return (
        <>
            <div id="pizza_card" key={pizzas[pizzaIndex].id} className="border rounded bg-white align-items-start d-flex  p-3">
                <div>
                ...
                <div className="p-3">
                    ...
                    <div className="align-items-stretch border-top pt-3">
                        ...
                        <div><Button className="bg-danger border-0 text-black" type="button" value={pizzas[pizzaIndex].id} onClick={(e) => addToCart(e,'value')}>Añadir 🛒</Button>
                        </div>
                    </div>
                </div>
            </div>
